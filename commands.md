...
- run the following commands, follow the sequence
  ...
  - ```bash
    ...
    git add .
    git commit -m "Remove iOS artifacts, version bump: v1.1.38.beta"
    git tag -a v1.1.38.beta -m "Remove iOS artifacts, version bump: v1.1.38.beta"
    git push origin v1.1.38.beta
